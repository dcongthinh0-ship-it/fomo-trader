...
- V3：已实现 Factory/token0/token1/fee/tickSpacing 识别、QuoterV2 精确输入报价、SwapRouter02 原生 ETH 买入、ERC-20 approval、反向卖出与 WETH 解包；路径带非零 `amountOutMinimum` 和 deadline multicall。
